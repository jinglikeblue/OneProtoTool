...
namespace Msg {
  ...
  public sealed class combat_wall : pb::IMessage {
    ...
    private static readonly pb::FieldCodec<global::Msg.combat_arrow> _repeated_arrow_codec
        = pb::FieldCodec.ForMessage(18, global::Msg.combat_arrow.Parser);
    private readonly pbc::RepeatedField<global::Msg.combat_arrow> arrow_ = new pbc::RepeatedField<global::Msg.combat_arrow>();
    /// <summary>
    ///箭塔
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::Msg.combat_arrow> Arrow {
      get { return arrow_; }
    }
  ...
  public sealed class combat_member : pb::IMessage {
    ...
    private static readonly pb::FieldCodec<global::Msg.combat_general> _repeated_generals_codec
        = pb::FieldCodec.ForMessage(18, global::Msg.combat_general.Parser);
    private readonly pbc::RepeatedField<global::Msg.combat_general> generals_ = new pbc::RepeatedField<global::Msg.combat_general>();
    /// <summary>
    ///武将
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::Msg.combat_general> Generals {
  ...
  public sealed class round_info : pb::IMessage {
    ...
    private static readonly pb::FieldCodec<global::Msg.once_attack> _repeated_battleValue_codec
        = pb::FieldCodec.ForMessage(42, global::Msg.once_attack.Parser);
    private readonly pbc::RepeatedField<global::Msg.once_attack> battleValue_ = new pbc::RepeatedField<global::Msg.once_attack>();
    /// <summary>
    ///本回合中的攻击(回血)
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::Msg.once_attack> BattleValue {
      get { return battleValue_; }
    }

    /// <summary>Field number for the "buffValue" field.</summary>
    public const int BuffValueFieldNumber = 6;
    private static readonly pb::FieldCodec<global::Msg.once_buff> _repeated_buffValue_codec
        = pb::FieldCodec.ForMessage(50, global::Msg.once_buff.Parser);
    private readonly pbc::RepeatedField<global::Msg.once_buff> buffValue_ = new pbc::RepeatedField<global::Msg.once_buff>();
    /// <summary>
    ///本回合中的buff
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::Msg.once_buff> BuffValue {
      get { return buffValue_; }
    }

    /// <summary>Field number for the "backValue" field.</summary>
    public const int BackValueFieldNumber = 7;
    private static readonly pb::FieldCodec<global::Msg.once_back> _repeated_backValue_codec
        = pb::FieldCodec.ForMessage(58, global::Msg.once_back.Parser);
    private readonly pbc::RepeatedField<global::Msg.once_back> backValue_ = new pbc::RepeatedField<global::Msg.once_back>();
    /// <summary>
    ///本回合中的反伤，吸血
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::Msg.once_back> BackValue {
      get { return backValue_; }
    }

    /// <summary>Field number for the "buffstep" field.</summary>
    public const int BuffstepFieldNumber = 8;
    private static readonly pb::FieldCodec<global::Msg.once_buffstep> _repeated_buffstep_codec
        = pb::FieldCodec.ForMessage(66, global::Msg.once_buffstep.Parser);
    private readonly pbc::RepeatedField<global::Msg.once_buffstep> buffstep_ = new pbc::RepeatedField<global::Msg.once_buffstep>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::Msg.once_buffstep> Buffstep {
  ...
  public sealed class combatInfo : pb::IMessage {
    ...
    private global::Msg.combat_member attacker_;
    /// <summary>
    ///combat_point point = 1;
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Msg.combat_member Attacker {
    ...
    private global::Msg.combat_member defencer_;
    /// <summary>
    ///防守方
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Msg.combat_member Defencer {
    ...
    private global::Msg.combat_wall wall_;
    /// <summary>
    ///箭塔信息
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::Msg.combat_wall Wall {
      get { return wall_; }
      set {
        wall_ = value;
      }
    ...
    private static readonly pb::FieldCodec<global::Msg.round_info> _repeated_rounsds_codec
        = pb::FieldCodec.ForMessage(34, global::Msg.round_info.Parser);
    private readonly pbc::RepeatedField<global::Msg.round_info> rounsds_ = new pbc::RepeatedField<global::Msg.round_info>();
    /// <summary>
    ///每回合数据
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::Msg.round_info> Rounsds {
      get { return rounsds_; }
    }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 10: {
            if (attacker_ == null) {
              attacker_ = new global::Msg.combat_member();
            }
          ...
          case 18: {
            if (defencer_ == null) {
              defencer_ = new global::Msg.combat_member();
            }
          ...
          case 26: {
            if (wall_ == null) {
              wall_ = new global::Msg.combat_wall();
            }
